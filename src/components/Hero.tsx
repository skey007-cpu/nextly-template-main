...
import eroImg from "../../public/img/ero.png";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Dinheiro rápido, 100% seguro, Taxas baixas
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
             Faça face às suas despesas imprevistas ou concretize os seus projetos sem ter de esperar pelo seu próximo salário. A nossa solução de empréstimo até ao próximo salário permite-lhe aceder rapidamente aos fundos de que necessita, através de um processo simples, rápido e seguro.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            ...
            Mais de <span className="text-indigo-600">2000+</span>{" "} clientes em todo o mundo confiam em nós
          </div>
